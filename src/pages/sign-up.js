    ...
    const handleSignup = async (event) => {
        ...
        if(!usernameExists.length){
            try {
                ...
                // firebase user collection (create a database)
        ...
        <div className="container flex mx-auto max-w-screen-md items-center h-screen">
            <div className="flex w-3/5">
                ...
                <div className="flex flex-col w-2/5">
                            ...
                            <input
                                ...
                                placeholder="Username"
                                    className="text-sm text-gray-base w-full mr-3 py-5 px-4 h-2
                                        border border-gray-primary rounder mb-2"
                    ...
                    <div className="flex justify-content items-center flex-col w-full bg-white p-4 
